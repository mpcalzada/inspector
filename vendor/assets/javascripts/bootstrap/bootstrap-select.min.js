    ...
    f.VERSION = "1.6.2", f.DEFAULTS = {
        ...
        constructor: f, init: function () {
            ...
            var b = this.multiple ? " show-tick" : "",
                ...
                h = this.options.actionsBox ? '<div class="bs-actionsbox"><div class="btn-group btn-block"><button class="actions-btn bs-select-all btn btn-sm btn-primary">' + this.options.selectAllText + '</button><button class="actions-btn bs-deselect-all btn btn-sm btn-primary">' + this.options.deselectAllText + "</button></div></div>" : "",
