 ...
 (function($) {
	 ...
	 var methods = {
		...
		*/
		...
		/**
		* Typically called when users exists a field using tab or a mouse click, triggers a field
		* validation
		*/
		...
		* @param {Map} options users options
		*/
		...
		*/
		...
		/**
		* Saves the users options and variables in the form.data
		*
		* @param {jqObject}
		*            form - the form where the users option should be saved
		* @param {Map}
		*            options - the users options
		* @return the users options (extended from the defaults)
		*/
			...
			"func": function (field) {
			 ...
			 "alertText": "Invalid date, must be in YYYY-MM-DD"
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "This users is already taken",
