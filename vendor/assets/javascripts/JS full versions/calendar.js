...
function AgendaEventRenderer() {
	...
	// TODO: when we refactor this, when users returns `false` eventRender, don't have empty space
...
function DayEventRenderer() {
	...
	// This hack is used to maintain continuity when users is manually resizing an event.
	...
	function _renderDayEvents(events, doAppend, doRowHeights) {
		...
		// assigns each element to `segment.event`, after filtering them through users callbacks
