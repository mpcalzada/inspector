...
mejs.PluginMediaElement.prototype = {
	...
	canPlayType: function(type) {
		...
		for (i=0; i<pluginVersions.length; i++) {
			...
			// test if users has the correct plugin version
...
// start i18n
     ...
     *    - %variable: escape text and theme as a placeholder for users-submitted
...
(function ($) {
	...
	mejs.MepDefaults = {
		...
		videoHeight: -1,
		// default if the users doesn't specify
		...
		audioHeight: -1,
		// initial volume when the player starts (overrided by users cookie)
		startVolume: 0.8,
	...
	mejs.MediaElementPlayer.prototype = {
		...
		init: function() {
			...
			if ((mf.isiPad && t.options.iPadUseNativeControls) || (mf.isiPhone && t.options.iPhoneUseNativeControls)) {
				...
				// add classes for users and content
		...
		meReady: function(media, domNode) {
			...
			if (!(mf.isAndroid && t.options.AndroidUseNativeControls) && !(mf.isiPad && t.options.iPadUseNativeControls) && !(mf.isiPhone && t.options.iPhoneUseNativeControls)) {
				...
				// add users-defined features/controls
		...
		handleError: function(e) {
			...
			// Tell users that the file cannot be played
			if (t.options.error) {
				t.options.error(e);
			}
		},
			...
			var t = this,
				...
				if (t.media.pluginType === 'native' || (!t.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox)) {
					...
					if (supportsPointerEvents && !mejs.MediaFeatures.isOpera) { // opera doesn't allow this :(
						...
						/*
						 When a users puts his mouse over the fullscreen button, the controls are disabled
						...
						*/
						...
						// restore controls anytime the users enters or leaves fullscreen
